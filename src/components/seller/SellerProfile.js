...
function SellerProfile() {
    ...
    function changeProfile() {
        ...
        const url = "http://192.168.40.111:8080/users/change-profile"
        axios
            .put(url, {
    ...
    const url = "http://192.168.40.111:8080/users/" + sessionStorage.getItem('authenticatedUser');
    useEffect(() => {
        ...
        <div>
            <div className="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body" id="farmerdp">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <Image />
                                    <div class="mt-3">
                                        <h4 className="text text-white">{personalInfo.firstname}</h4>
                                        <p class=" text-white mb-1">{personalInfo.mobileNo}</p>
                                        <p class=" text-white font-size-sm">{personalInfo.email}</p>
                                        <button class="btn btn-primary">Follow</button>
                                        <button class="btn btn-primary mx-2">Message</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-12" style={{ marginTop: "10px" }}>
                        <div class="card-body d-flex justify-content-center col-lg-12">
                            ...
                            <div class="card-text col-12">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!nameflag && <button type="button" name="name" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {nameflag && <input type="text" class="form-control" name="name" placeholder="Enter New Name"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!mobileNoflag && <button type="button" name="mobileNo" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {mobileNoflag && <input type="text" name="mobileNo" class="form-control" placeholder="Enter New mobile Number"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!dateOfBirthflag && <button type="button" name="dateOfBirth" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {dateOfBirthflag && <input type="date" name="dateOfBirth" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!streetAddressflag && <button type="button" name="streetAddress" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {streetAddressflag && <input type="text" class="form-control" name="streetAddress" placeholder="Enter New Address"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!aadharNoflag && <button type="button" name="aadharNo" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {aadharNoflag && <input type="text" class="form-control" name="aadharNo" placeholder="Enter New Address"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!genderflag && <button type="button" name="gender" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {genderflag && <input type="text" class="form-control" name="gender" placeholder="Enter Gender"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!stateflag && <button type="button" name="state" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {stateflag && <input type="text" class="form-control" name="state" placeholder="Enter state"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!districtflag && <button type="button" name="district" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {districtflag && <input type="text" class="form-control" name="district" placeholder="Enter District"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 mt-2 text-secondary">
                                                    {!pincodeflag && <button type="button" name="pincode" class="btn btn-link" onClick={handleFlag}>change</button>}
                                                    {pincodeflag && <input type="text" class="form-control" name="pincode" placeholder="Enter picode"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    {!passwordflag && <button type="button" name="password" class="btn btn-link" onClick={handleFlag}>change password</button>}
                                ...
                                {
                                    (nameflag || usernameflag || emailflag || streetAddressflag || passwordflag || mobileNoflag || dateOfBirthflag || genderflag || stateflag || districtflag) &&
